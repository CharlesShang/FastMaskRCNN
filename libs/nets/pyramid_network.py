...
def build_heads(pyramid, image_height, image_width, num_classes, base_anchors, is_training=False, gt_boxes=None):
...
def build_losses(pyramid, image_height, image_width, outputs, gt_boxes, gt_masks,
